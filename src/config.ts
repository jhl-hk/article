...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		credit: {
			...
			text: "JHL-HK", // Credit text to be displayed
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/portrait.jpg", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
	name: "Jianyue Hugo Liang",
	bio: "Developer | Translator | Student",
	links: [
		{
			name: "GitHub",
